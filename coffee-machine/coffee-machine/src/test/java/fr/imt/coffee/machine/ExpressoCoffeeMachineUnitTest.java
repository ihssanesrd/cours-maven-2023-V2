...
import fr.imt.storage.cupboard.container.*;
...
public class ExpressoCoffeeMachineUnitTest {
    public EspressoCoffeeMachine espressoCoffeeMachineUnderTest;

    @BeforeEach
    public void beforeTest() {
        espressoCoffeeMachineUnderTest = new EspressoCoffeeMachine(0, 10,
                0, 10, 700);
    }
    ...
    void testSameCoffeeType() {
        ...
        espressoCoffeeMachineUnderTest.addWaterInTank(5);

        espressoCoffeeMachineUnderTest.addCoffeeInBeanTank(5, CoffeeType.ARABICA_CREMA);

        Assertions.assertThrows(CoffeeTypeCupDifferentOfCoffeeTypeTankException.class, () -> {
            espressoCoffeeMachineUnderTest.makeACoffee(cup, CoffeeType.ROBUSTA);
        });
